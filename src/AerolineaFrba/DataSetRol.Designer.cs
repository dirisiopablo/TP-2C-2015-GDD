...
namespace AerolineaFrba.DataSetRolTableAdapters {
    ...
    public partial class RolTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [BIEN_MIGRADO_RAFA].[Rol] WHERE (([id] = @Original_id) AND ((@IsNull_" +
                ...
                "cion)) AND ((@IsNull_activo = 1 AND [activo] IS NULL) OR ([activo] = @Original_a" +
                "ctivo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [BIEN_MIGRADO_RAFA].[Rol] ([descripcion], [activo]) VALUES (@descripc" +
                "ion, @activo);\r\nSELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Rol WHERE " +
                "(id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [BIEN_MIGRADO_RAFA].[Rol] SET [descripcion] = @descripcion, [activo] = @activo WHERE (([id] = @Original_id) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_descripcion)) AND ((@IsNull_activo = 1 AND [activo] IS NULL) OR ([activo] = @Original_activo)));
SELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Rol WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Rol";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Rol";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Rol";
        ...
        public virtual int Fill(DataSetRol.RolDataTable dataTable) {
        ...
        public virtual DataSetRol.RolDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int FillBy(DataSetRol.RolDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillFiltered(DataSetRol.RolDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_descripcion, global::System.Nullable<bool> Original_activo) {
        ...
        public virtual int Update(string descripcion, global::System.Nullable<bool> activo, int Original_id, string Original_descripcion, global::System.Nullable<bool> Original_activo, int id) {
            if ((descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string descripcion, global::System.Nullable<bool> activo, int Original_id, string Original_descripcion, global::System.Nullable<bool> Original_activo) {
