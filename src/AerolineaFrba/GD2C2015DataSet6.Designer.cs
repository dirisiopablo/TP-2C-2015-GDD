...
namespace AerolineaFrba {
    ...
    public partial class GD2C2015DataSet6 : global::System.Data.DataSet {
        ...
        public partial class CiudadDataTable : global::System.Data.TypedTableBase<CiudadRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CiudadRow AddCiudadRow(string descripcion, bool activo) {
    ...
    public partial class CiudadTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [BIEN_MIGRADO_RAFA].[Ciudad] WHERE (([id] = @Original_id) AND ((@IsNu" +
                ...
                "ripcion)) AND ((@IsNull_activo = 1 AND [activo] IS NULL) OR ([activo] = @Origina" +
                "l_activo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [BIEN_MIGRADO_RAFA].[Ciudad] ([descripcion], [activo]) VALUES (@descr" +
                "ipcion, @activo);\r\nSELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Ciudad " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [BIEN_MIGRADO_RAFA].[Ciudad] SET [descripcion] = @descripcion, [activo] = @activo WHERE (([id] = @Original_id) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_descripcion)) AND ((@IsNull_activo = 1 AND [activo] IS NULL) OR ([activo] = @Original_activo)));
SELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Ciudad WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, descripcion, activo FROM BIEN_MIGRADO_RAFA.Ciudad";
        ...
        public virtual int Fill(GD2C2015DataSet6.CiudadDataTable dataTable) {
        ...
        public virtual GD2C2015DataSet6.CiudadDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GD2C2015DataSet6.CiudadDataTable dataTable = new GD2C2015DataSet6.CiudadDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GD2C2015DataSet6.CiudadDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GD2C2015DataSet6 dataSet) {
